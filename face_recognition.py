...
class Face_Recognition :
    def __init__(self,root):
         ...
         #title
         title_lbl=Label(self.root, text="FACE RECOGNITION",font=("cambria",35,"bold"),bg="white",fg="green")
         title_lbl.place(x=0,y=0,width=1540,height=55)
         

         #bottom image
         img_bottom = Image.open("C:/Users/lenovo/OneDrive/Desktop/Attendance system/college_images/scan1.webp")
         img_bottom = img_bottom.resize((1540,740), Image.Resampling.LANCZOS)
         ...
         #button
         b1_1=Button(f_lbl,text="Face Recognition",cursor="hand2",command=self.face_recog,font=("cambria",20,"bold"),bg="dark green",fg="white")
         b1_1.place(x=540,y=653,width=455,height=40)
    

    #attendance
    def mark_attendance(self,i,n,d):
        with open("Swati.csv","r+",newline="\n") as f:
